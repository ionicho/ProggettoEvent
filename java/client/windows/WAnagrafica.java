...
/**
 * Bozza di finestra per eventuale futura implementazione
 * di ricerca e/o gestione analoga di una camera (da generalizzare
 * alla classe astratta WResource).
 */

public class WAnagrafica {
